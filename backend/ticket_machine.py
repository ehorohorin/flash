...
Введи свои данные Ф.И.О., серию и номер паспорта без пробела, номер телефона, через запятую.
Пример: Иванов Иван Андреевич, 1635109854, +79000009999""",
"""Шаг 5. Осталось перевести мешок золота на этот счет - 4536 3121 3131 3213.
Шучу, это же PoC. Сейчас прилетит билет"""]
    custom_messages = {"sendqr":"Получика свой qr"}
